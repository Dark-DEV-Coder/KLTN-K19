...
import { fetchDetailQuyenTK, fetchAllChucNang, fetchEditQuyenTK } from "../../GetData"
            ...
            <main className="main2">
                ...
                <form className="form-new">
                    <div className="container-edit">
                        ...
                        <button className="btn" type="button" onClick={() => handleEditQuyenTK()} style={{ marginTop: '2rem' }}>Lưu</button>
                    </div>
                </form>
