                ...
                <div className="container-edit">
                    <div className="form-row">
                        <div className="form-group col-md-6">
                            ...
                            <input type="text" className="form-control" id="inputTenDT" value={ten} onChange={(event) => onChangeInput(event, SetTen)} disabled />
                        </div>
                        <div className="form-group col-md-6">
                            <label className="inputDT" for="inputGiangvienhuongdan">Giảng viên hướng dẫn</label>
                            <input type="text" className="form-control" id="inputGiangvienhuongdan" value={giangvienhuongdan} onChange={(event) => onChangeInput(event, SetGiangvienhuongdan)} disabled />
                        </div>
                    </div>
                    ...
                    <div className="form-row">
                        <div className="form-group col-md-12">
                            ...
                            <input type="text" className="form-control" id="inputDonviCT" value={donvi} onChange={(event) => onChangeInput(event, SetDonvi)} disabled />
                        </div>
                        {/* <div className="form-group col-md-6">
                            <label className="inputDT" for="inputChuyennganh">Chuyên ngành</label>
                    ...
                    <div className="form-row">
                        <div className="form-group col-md-2">
                            ...
                            <input type="text" className="form-control" id="inputSDTSV1" value={mssvsinhvien1} onChange={(event) => onChangeInput(event, SetMssvsinhvien1)} disabled />
                        </div>
                        <div className="form-group col-md-3">
                            <label className="inputDT" for="inputSV1">Sinh viên 1</label>
                            <input type="text" className="form-control" id="inputSV1" value={sinhvien1} onChange={(event) => onChangeInput(event, SetSinhvien1)} disabled />
                        </div>
                        <div className="form-group col-md-3">
                            <label className="inputDT" for="inputEmailSV1">Email</label>
                            <input type="text" className="form-control" id="inputEmailSV1" value={emailsinhvien1} onChange={(event) => onChangeInput(event, SetEmailsinhvien1)} disabled />
                        </div>
                        <div className="form-group col-md-2">
                            <label className="inputDT" for="inputSTCSV1">Số tín chỉ tích lũy</label>
                            <input type="text" className="form-control" id="inputSTCSV1" value={stcsinhvien1} onChange={(event) => onChangeInput(event, SetStcsinhvien1)} disabled />
                        </div>
                        <div className="form-group col-md-2">
                            <label className="inputDT" for="inputDTB1">Điểm TB tích lũy hệ 4</label>
                            <input type="text" className="form-control" id="inputDTB1" value={dtlsinhvien1} onChange={(event) => onChangeInput(event, SetDtlsinhvien1)} disabled />
                        </div>
                    </div>
                    ...
                    <div className="form-row">
                        <div className="form-group col-md-2">
                            ...
                            <input type="text" className="form-control" id="inputSDTSV2" value={mssvsinhvien2} onChange={(event) => onChangeInput(event, SetMssvsinhvien2)} disabled />
                        </div>
                        <div className="form-group col-md-3">
                            <label className="inputDT" for="inputSV2">Sinh viên 2</label>
                            <input type="text" className="form-control" id="inputSV2" value={sinhvien2} onChange={(event) => onChangeInput(event, SetSinhvien2)} disabled />
                        </div>
                        <div className="form-group col-md-3">
                            <label className="inputDT" for="inputEmailSV2">Email</label>
                            <input type="text" className="form-control" id="inputEmailSV2" value={emailsinhvien2} onChange={(event) => onChangeInput(event, SetEmailsinhvien2)} disabled />
                        </div>
                        <div className="form-group col-md-2">
                            <label className="inputDT" for="inputSTCSV2">Số tín chỉ tích lũy</label>
                            <input type="text" className="form-control" id="inputSTCSV2" value={stcsinhvien2} onChange={(event) => onChangeInput(event, SetStcsinhvien2)} disabled />
                        </div>
                        <div className="form-group col-md-2">
                            <label className="inputDT" for="inputDTB2">Điểm TB tích lũy hệ 4</label>
                            <input type="text" className="form-control" id="inputDTB2" value={dtlsinhvien2} onChange={(event) => onChangeInput(event, SetDtlsinhvien2)} disabled />
                        </div>
                    </div>

                    <div className="form-row" style={{ marginBottom: '16rem' }}>
                        <div className="form-group col-md-12">
                            <label className="inputDT" for="inputTrangthai">Trạng thái</label>
                            <select value={trangthai} onChange={(event) => onChangeSelect(event, SetTrangthai)} id="inputTrangthai" className="form-control" disabled>
